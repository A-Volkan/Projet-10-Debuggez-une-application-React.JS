...
const Page = () => {
  const { data } = useData(); // extrait la data de context pour acceder au evenement 
  const last = data?.events[data.events.length - 1]; // permet d'obtenir le dernier evenements de la liste d'evenements grace a son index (-1 pour etre dur d'obtenir le dernier elements de la liste car sa start a 0) 
  return <>
    <header>
      <Menu />
    </header>
    <main>
      ...
      <section className="ServicesContainer">
        ...
        <div className="ListContainer" data-testid='event-list-testid'>
